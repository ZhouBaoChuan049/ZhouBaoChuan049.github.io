...
onMount(() => {
    ...
    document.addEventListener("wallpaper-mode-changed", onModeChanged);
    return () => {
        document.removeEventListener("click", handleClickOutside);
        document.removeEventListener("wallpaper-mode-changed", onModeChanged);
    };
});
</script>
